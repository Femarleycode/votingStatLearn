...
# Correlation Matrix
## Choose numerical or ordinal columns for correlation matrix
non_cat = df[['age', 'political_attention', 'newspaper_readership', 'profile_gross_personal', 
              'profile_gross_household', 'education_age', 'socialgradeCIE1', 'socialgradeCIE2', 
              'Weight', 'Hindsight', 'Poscountry', 'Posind', 'Govthand', 'Tradeimmig', 
              'BrexitID', 'Leaverimport', 'Remainimport', 'Genecon']]

## Create correlation matrix
corr_matrix=non_cat.corr()
